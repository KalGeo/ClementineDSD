...
#include <memory>
#include "../../../src/devices/devicedatabasebackend.h"
...
struct qt_meta_stringdata_DeviceDatabaseBackend_t {
    QByteArrayData data[3];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DeviceDatabaseBackend_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DeviceDatabaseBackend_t qt_meta_stringdata_DeviceDatabaseBackend = {
    {
QT_MOC_LITERAL(0, 0, 21), // "DeviceDatabaseBackend"
QT_MOC_LITERAL(1, 22, 0), // ""
QT_MOC_LITERAL(2, 23, 6) // "parent"

    },
    "DeviceDatabaseBackend\0\0parent"
};
...
QT_INIT_METAOBJECT const QMetaObject DeviceDatabaseBackend::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DeviceDatabaseBackend.data,
    qt_meta_data_DeviceDatabaseBackend,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DeviceDatabaseBackend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceDatabaseBackend.stringdata0))
