...
#include <memory>
#include "../../../src/devices/mtploader.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MtpLoader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MtpLoader_t qt_meta_stringdata_MtpLoader = {
    {
QT_MOC_LITERAL(0, 0, 9), // "MtpLoader"
QT_MOC_LITERAL(1, 10, 5), // "Error"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 7), // "message"
QT_MOC_LITERAL(4, 25, 11), // "TaskStarted"
QT_MOC_LITERAL(5, 37, 7), // "task_id"
QT_MOC_LITERAL(6, 45, 12), // "LoadFinished"
QT_MOC_LITERAL(7, 58, 7), // "success"
QT_MOC_LITERAL(8, 66, 12) // "LoadDatabase"

    },
    "MtpLoader\0Error\0\0message\0TaskStarted\0"
    "task_id\0LoadFinished\0success\0LoadDatabase"
};
...
void MtpLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MtpLoader::Error)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MtpLoader::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MtpLoader::TaskStarted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MtpLoader::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MtpLoader::LoadFinished)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MtpLoader::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MtpLoader.data,
...
// SIGNAL 2
void MtpLoader::LoadFinished(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
