...
#include <memory>
#include "../../../src/devices/giolister.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GioLister_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GioLister_t qt_meta_stringdata_GioLister = {
    {
QT_MOC_LITERAL(0, 0, 9), // "GioLister"
QT_MOC_LITERAL(1, 10, 21), // "UpdateDeviceFreeSpace"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 2), // "id"
QT_MOC_LITERAL(4, 36, 13), // "DoMountDevice"
QT_MOC_LITERAL(5, 50, 10) // "request_id"

    },
    "GioLister\0UpdateDeviceFreeSpace\0\0id\0"
    "DoMountDevice\0request_id"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_GioLister[] = {
...
void GioLister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->DoMountDevice((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject GioLister::staticMetaObject = { {
    QMetaObject::SuperData::link<DeviceLister::staticMetaObject>(),
    qt_meta_stringdata_GioLister.data,
