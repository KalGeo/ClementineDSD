...
#include <memory>
#include "../../../src/devices/cddalister.h"
...
struct qt_meta_stringdata_CddaLister_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CddaLister_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CddaLister_t qt_meta_stringdata_CddaLister = {
    {
QT_MOC_LITERAL(0, 0, 10) // "CddaLister"
...
QT_INIT_METAOBJECT const QMetaObject CddaLister::staticMetaObject = { {
    QMetaObject::SuperData::link<DeviceLister::staticMetaObject>(),
    qt_meta_stringdata_CddaLister.data,
    qt_meta_data_CddaLister,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CddaLister::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CddaLister.stringdata0))
