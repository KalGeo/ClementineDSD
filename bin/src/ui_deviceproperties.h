...
public:
    ...
    void retranslateUi(QDialog *DeviceProperties)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("DeviceProperties", "Hardware information", nullptr));
        ...
        label_3->setText(QCoreApplication::translate("DeviceProperties", "Clementine can automatically convert the music you copy to this device into a format that it can play.", nullptr));
        ...
        label_7->setText(QCoreApplication::translate("DeviceProperties", "This device must be connected and opened before Clementine can see what file formats it supports.", nullptr));
