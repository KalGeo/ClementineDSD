...
public:
    ...
    {
        WiimoteSettingsPage->setWindowTitle(QCoreApplication::translate("WiimoteSettingsPage", "Wiimotedev", nullptr));
        wiimotedev_enable->setText(QCoreApplication::translate("WiimoteSettingsPage", "Enable Wii Remote support", nullptr));
        label_2->setText(QCoreApplication::translate("WiimoteSettingsPage", "You can use your Wii Remote as a remote control for Clementine.  <a href=\"http://www.clementine-player.org/wiimote\">See the page on the Clementine wiki</a> for more information.\n"
"", nullptr));
        wiimotedev_active->setText(QCoreApplication::translate("WiimoteSettingsPage", "Connect Wii Remotes using active/deactive action", nullptr));
        wiimotedev_focus->setText(QCoreApplication::translate("WiimoteSettingsPage", "Enable shortcuts only when Clementine is focused", nullptr));
        wiimotedev_notification->setText(QCoreApplication::translate("WiimoteSettingsPage", "Use notifications to report Wii Remote status", nullptr));
        label->setText(QCoreApplication::translate("WiimoteSettingsPage", "Use Wii Remote", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = list->headerItem();
        ___qtreewidgetitem->setText(1, QCoreApplication::translate("WiimoteSettingsPage", "Action", nullptr));
        ___qtreewidgetitem->setText(0, QCoreApplication::translate("WiimoteSettingsPage", "Buttons", nullptr));
        wiimotedev_add_action->setText(QCoreApplication::translate("WiimoteSettingsPage", "Add action", nullptr));
        wiimotedev_delete_action->setText(QCoreApplication::translate("WiimoteSettingsPage", "Remove action", nullptr));
        wiimotedev_reload->setText(QCoreApplication::translate("WiimoteSettingsPage", "Defaults", nullptr));
    } // retranslateUi
