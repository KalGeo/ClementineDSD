...
#include <memory>
#include "../../../src/playlistparsers/asxiniparser.h"
...
struct qt_meta_stringdata_AsxIniParser_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AsxIniParser_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AsxIniParser_t qt_meta_stringdata_AsxIniParser = {
    {
QT_MOC_LITERAL(0, 0, 12) // "AsxIniParser"
...
QT_INIT_METAOBJECT const QMetaObject AsxIniParser::staticMetaObject = { {
    QMetaObject::SuperData::link<ParserBase::staticMetaObject>(),
    qt_meta_stringdata_AsxIniParser.data,
    qt_meta_data_AsxIniParser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AsxIniParser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AsxIniParser.stringdata0))
