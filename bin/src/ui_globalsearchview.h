...
public:
    ...
    {
        search->setProperty("placeholderText", QVariant(QCoreApplication::translate("GlobalSearchView", "Search for anything", nullptr)));
        help_text->setText(QCoreApplication::translate("GlobalSearchView", "Enter search terms above to find music on your computer and on the internet", nullptr));
        label_2->setText(QCoreApplication::translate("GlobalSearchView", "Clementine will find music in:", nullptr));
        disabled_label->setText(QCoreApplication::translate("GlobalSearchView", "But these sources are disabled:", nullptr));
        label->setText(QCoreApplication::translate("GlobalSearchView", "Why not try...", nullptr));
        (void)GlobalSearchView;
    } // retranslateUi
