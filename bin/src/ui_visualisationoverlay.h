...
"}"));
    ...
    {
        VisualisationOverlay->setWindowTitle(QCoreApplication::translate("VisualisationOverlay", "Form", nullptr));
        song_title->setText(QCoreApplication::translate("VisualisationOverlay", "Clementine", nullptr));
#if QT_CONFIG(tooltip)
        settings->setToolTip(QCoreApplication::translate("VisualisationOverlay", "Visualizations Settings", nullptr));
