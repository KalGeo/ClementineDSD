...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MoodbarPipeline_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MoodbarPipeline_t qt_meta_stringdata_MoodbarPipeline = {
    {
QT_MOC_LITERAL(0, 0, 15), // "MoodbarPipeline"
...
QT_MOC_LITERAL(4, 34, 5) // "Start"
    ...
    "MoodbarPipeline\0Finished\0\0success\0"
    "Start"
};
...
void MoodbarPipeline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MoodbarPipeline::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MoodbarPipeline::Finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MoodbarPipeline::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MoodbarPipeline.data,
