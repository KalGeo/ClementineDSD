...
public:
    ...
    void setupUi(QWidget *TranscoderOptionsMP3)
    {
        ...
        quality_spinbox->setMaximum(9.990000000000000);
        quality_spinbox->setValue(4.000000000000000);
    ...
    void retranslateUi(QWidget *TranscoderOptionsMP3)
    {
        ...
        label->setText(QCoreApplication::translate("TranscoderOptionsMP3", "Quality", "Sound quality"));
        target_bitrate->setText(QCoreApplication::translate("TranscoderOptionsMP3", "Optimize for bitrate", nullptr));
