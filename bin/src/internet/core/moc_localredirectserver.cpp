...
#include <memory>
#include "../../../../src/internet/core/localredirectserver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LocalRedirectServer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LocalRedirectServer_t qt_meta_stringdata_LocalRedirectServer = {
    {
QT_MOC_LITERAL(0, 0, 19), // "LocalRedirectServer"
...
QT_MOC_LITERAL(7, 73, 6) // "buffer"

    },
    "LocalRedirectServer\0Finished\0\0"
    "NewConnection\0ReadyRead\0QTcpSocket*\0"
    "socket\0buffer"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_LocalRedirectServer[] = {
...
void LocalRedirectServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ReadyRead((*reinterpret_cast< QTcpSocket*(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LocalRedirectServer::Finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LocalRedirectServer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LocalRedirectServer.data,
