...
#include <memory>
#include "../../../../src/internet/podcasts/fixedopmlpage.h"
...
struct qt_meta_stringdata_FixedOpmlPage_t {
    QByteArrayData data[5];
    char stringdata0[57];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FixedOpmlPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FixedOpmlPage_t qt_meta_stringdata_FixedOpmlPage = {
    {
QT_MOC_LITERAL(0, 0, 13), // "FixedOpmlPage"
QT_MOC_LITERAL(1, 14, 12), // "LoadFinished"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 22), // "PodcastUrlLoaderReply*"
QT_MOC_LITERAL(4, 51, 5) // "reply"

    },
    "FixedOpmlPage\0LoadFinished\0\0"
...
void FixedOpmlPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FixedOpmlPage *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FixedOpmlPage::staticMetaObject = { {
    QMetaObject::SuperData::link<AddPodcastPage::staticMetaObject>(),
    qt_meta_stringdata_FixedOpmlPage.data,
    qt_meta_data_FixedOpmlPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FixedOpmlPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FixedOpmlPage.stringdata0))
