...
#include <memory>
#include "../../../src/ui/networkproxysettingspage.h"
...
struct qt_meta_stringdata_NetworkProxySettingsPage_t {
    QByteArrayData data[1];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NetworkProxySettingsPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetworkProxySettingsPage_t qt_meta_stringdata_NetworkProxySettingsPage = {
    {
QT_MOC_LITERAL(0, 0, 24) // "NetworkProxySettingsPage"
...
QT_INIT_METAOBJECT const QMetaObject NetworkProxySettingsPage::staticMetaObject = { {
    QMetaObject::SuperData::link<SettingsPage::staticMetaObject>(),
    qt_meta_stringdata_NetworkProxySettingsPage.data,
    qt_meta_data_NetworkProxySettingsPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NetworkProxySettingsPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetworkProxySettingsPage.stringdata0))
