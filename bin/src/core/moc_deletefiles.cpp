...
QT_MOC_LITERAL(3, 22, 8), // "SongList"
QT_MOC_LITERAL(4, 31, 17), // "songs_with_errors"
QT_MOC_LITERAL(5, 49, 16) // "ProcessSomeFiles"

    },
    "DeleteFiles\0Finished\0\0SongList\0"
    "songs_with_errors\0ProcessSomeFiles"
};
...
void DeleteFiles::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeleteFiles::Finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DeleteFiles::staticMetaObject = { {
    ...
    qt_meta_stringdata_DeleteFiles.data,
