...
QT_MOC_LITERAL(1, 12, 12), // "TasksChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 20), // "PauseLibraryWatchers"
QT_MOC_LITERAL(4, 47, 21) // "ResumeLibraryWatchers"

    },
    "TaskManager\0TasksChanged\0\0"
    "PauseLibraryWatchers\0ResumeLibraryWatchers"
};
...
void TaskManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->PauseLibraryWatchers(); break;
        case 2: _t->ResumeLibraryWatchers(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskManager::TasksChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TaskManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskManager::PauseLibraryWatchers)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TaskManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskManager::ResumeLibraryWatchers)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void TaskManager::PauseLibraryWatchers()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void TaskManager::ResumeLibraryWatchers()
{
