...
public:
    ...
    void retranslateUi(QWidget *NetworkProxySettingsPage)
    {
        ...
        label_15->setText(QCoreApplication::translate("NetworkProxySettingsPage", "Port", nullptr));
        proxy_auth->setTitle(QCoreApplication::translate("NetworkProxySettingsPage", "Use authentication", nullptr));
        label_16->setText(QCoreApplication::translate("NetworkProxySettingsPage", "Username", nullptr));
        label_17->setText(QCoreApplication::translate("NetworkProxySettingsPage", "Password", nullptr));
    } // retranslateUi
