...
public:
    ...
    void retranslateUi(QDialog *TrackSelectionDialog)
    {
        ...
        label_5->setText(QCoreApplication::translate("TrackSelectionDialog", "Sorry", nullptr));
        label_4->setText(QCoreApplication::translate("TrackSelectionDialog", "Clementine was unable to find results for this file", nullptr));
        label->setText(QCoreApplication::translate("TrackSelectionDialog", "Select best possible match", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = results->headerItem();
        ___qtreewidgetitem->setText(4, QCoreApplication::translate("TrackSelectionDialog", "Album", nullptr));
        ___qtreewidgetitem->setText(3, QCoreApplication::translate("TrackSelectionDialog", "Artist", nullptr));
