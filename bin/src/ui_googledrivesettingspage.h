...
public:
    ...
    {
        GoogleDriveSettingsPage->setWindowTitle(QCoreApplication::translate("GoogleDriveSettingsPage", "Google Drive", nullptr));
        label->setText(QCoreApplication::translate("GoogleDriveSettingsPage", "Clementine can play music that you have uploaded to Google Drive", nullptr));
        login_button->setText(QCoreApplication::translate("GoogleDriveSettingsPage", "Login", nullptr));
        label_2->setText(QCoreApplication::translate("GoogleDriveSettingsPage", "Clicking the Login button will open a web browser.  You should return to Clementine after you have logged in.", nullptr));
    } // retranslateUi
