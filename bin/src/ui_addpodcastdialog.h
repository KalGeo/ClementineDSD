...
public:
    ...
    {
        AddPodcastDialog->setWindowTitle(QCoreApplication::translate("AddPodcastDialog", "Add podcast", nullptr));
        widget->setProperty("text", QVariant(QCoreApplication::translate("AddPodcastDialog", "Loading...", nullptr)));
    } // retranslateUi
