...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DynamicPlaylistControls_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DynamicPlaylistControls_t qt_meta_stringdata_DynamicPlaylistControls = {
    {
QT_MOC_LITERAL(0, 0, 23), // "DynamicPlaylistControls"
QT_MOC_LITERAL(1, 24, 6), // "Expand"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "Repopulate"
QT_MOC_LITERAL(4, 43, 7) // "TurnOff"

    },
    "DynamicPlaylistControls\0Expand\0\0"
    "Repopulate\0TurnOff"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_DynamicPlaylistControls[] = {
...
void DynamicPlaylistControls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicPlaylistControls::Expand)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DynamicPlaylistControls::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicPlaylistControls::Repopulate)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (DynamicPlaylistControls::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DynamicPlaylistControls::TurnOff)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DynamicPlaylistControls::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DynamicPlaylistControls.data,
