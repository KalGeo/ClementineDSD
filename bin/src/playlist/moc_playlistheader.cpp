...
QT_MOC_LITERAL(5, 57, 30), // "SectionRatingLockStatusChanged"
QT_MOC_LITERAL(6, 88, 5), // "state"
QT_MOC_LITERAL(7, 94, 12), // "MouseEntered"
QT_MOC_LITERAL(8, 107, 11), // "HideCurrent"
QT_MOC_LITERAL(9, 119, 13), // "ToggleVisible"
QT_MOC_LITERAL(10, 133, 7), // "section"
QT_MOC_LITERAL(11, 141, 22), // "ToggleRatingEditStatus"
QT_MOC_LITERAL(12, 164, 18), // "SetColumnAlignment"
QT_MOC_LITERAL(13, 183, 8), // "QAction*"
QT_MOC_LITERAL(14, 192, 6) // "action"

    },
    "PlaylistHeader\0SectionVisibilityChanged\0"
    "\0logical\0visible\0SectionRatingLockStatusChanged\0"
    "state\0MouseEntered\0HideCurrent\0"
    "ToggleVisible\0section\0ToggleRatingEditStatus\0"
    "SetColumnAlignment\0QAction*\0action"
};
...
void PlaylistHeader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlaylistHeader *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->SectionVisibilityChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->SectionRatingLockStatusChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->MouseEntered(); break;
        case 3: _t->HideCurrent(); break;
        case 4: _t->ToggleVisible((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->ToggleRatingEditStatus(); break;
        case 6: _t->SetColumnAlignment((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject PlaylistHeader::staticMetaObject = { {
    QMetaObject::SuperData::link<StretchHeaderView::staticMetaObject>(),
    qt_meta_stringdata_PlaylistHeader.data,
    qt_meta_data_PlaylistHeader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
