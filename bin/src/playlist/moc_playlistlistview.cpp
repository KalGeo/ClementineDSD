...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlaylistListView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlaylistListView_t qt_meta_stringdata_PlaylistListView = {
    {
QT_MOC_LITERAL(0, 0, 16) // "PlaylistListView"
...
static const uint qt_meta_data_PlaylistListView[] = {
...
QT_INIT_METAOBJECT const QMetaObject PlaylistListView::staticMetaObject = { {
    QMetaObject::SuperData::link<AutoExpandingTreeView::staticMetaObject>(),
    qt_meta_stringdata_PlaylistListView.data,
