...
#include <memory>
#include "../../../src/analyzers/blockanalyzer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BlockAnalyzer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BlockAnalyzer_t qt_meta_stringdata_BlockAnalyzer = {
    {
QT_MOC_LITERAL(0, 0, 13), // "BlockAnalyzer"
QT_MOC_LITERAL(1, 14, 0), // ""
QT_MOC_LITERAL(2, 15, 8) // "QWidget*"

    },
    "BlockAnalyzer\0\0QWidget*"
};
...
QT_INIT_METAOBJECT const QMetaObject BlockAnalyzer::staticMetaObject = { {
    QMetaObject::SuperData::link<Analyzer::Base::staticMetaObject>(),
    qt_meta_stringdata_BlockAnalyzer.data,
