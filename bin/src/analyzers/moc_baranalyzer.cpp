...
#include <memory>
#include "../../../src/analyzers/baranalyzer.h"
...
struct qt_meta_stringdata_BarAnalyzer_t {
    QByteArrayData data[3];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BarAnalyzer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BarAnalyzer_t qt_meta_stringdata_BarAnalyzer = {
    {
QT_MOC_LITERAL(0, 0, 11), // "BarAnalyzer"
QT_MOC_LITERAL(1, 12, 0), // ""
QT_MOC_LITERAL(2, 13, 8) // "QWidget*"

    },
    "BarAnalyzer\0\0QWidget*"
};
...
QT_INIT_METAOBJECT const QMetaObject BarAnalyzer::staticMetaObject = { {
    QMetaObject::SuperData::link<Analyzer::Base::staticMetaObject>(),
    qt_meta_stringdata_BarAnalyzer.data,
    qt_meta_data_BarAnalyzer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BarAnalyzer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BarAnalyzer.stringdata0))
