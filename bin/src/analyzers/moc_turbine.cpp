...
#include <memory>
#include "../../../src/analyzers/turbine.h"
...
struct qt_meta_stringdata_TurbineAnalyzer_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TurbineAnalyzer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TurbineAnalyzer_t qt_meta_stringdata_TurbineAnalyzer = {
    {
QT_MOC_LITERAL(0, 0, 15), // "TurbineAnalyzer"
QT_MOC_LITERAL(1, 16, 0), // ""
QT_MOC_LITERAL(2, 17, 8), // "QWidget*"
QT_MOC_LITERAL(3, 26, 6) // "parent"

    },
    "TurbineAnalyzer\0\0QWidget*\0parent"
};
...
QT_INIT_METAOBJECT const QMetaObject TurbineAnalyzer::staticMetaObject = { {
    QMetaObject::SuperData::link<BoomAnalyzer::staticMetaObject>(),
    qt_meta_stringdata_TurbineAnalyzer.data,
    qt_meta_data_TurbineAnalyzer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TurbineAnalyzer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TurbineAnalyzer.stringdata0))
