...
public:
    ...
    {
        TranscoderOptionsWma->setWindowTitle(QCoreApplication::translate("TranscoderOptionsWma", "Form", nullptr));
        label->setText(QCoreApplication::translate("TranscoderOptionsWma", "Bitrate", nullptr));
        bitrate_spinbox->setSuffix(QCoreApplication::translate("TranscoderOptionsWma", " kbps", nullptr));
    } // retranslateUi
