...
public:
    ...
    {
        WiimoteShortcutGrabber->setWindowTitle(QCoreApplication::translate("WiimoteShortcutGrabber", "Add wiimotedev action", nullptr));
        label->setText(QCoreApplication::translate("WiimoteShortcutGrabber", "Press a button combination to use for", nullptr));
        combo->setText(QCoreApplication::translate("WiimoteShortcutGrabber", "Push Wiiremote button", nullptr));
        remember_shifts->setText(QCoreApplication::translate("WiimoteShortcutGrabber", "Remember Wii remote swing", nullptr));
        keep_label->setText(QCoreApplication::translate("WiimoteShortcutGrabber", "Keep buttons for %1 seconds...", nullptr));
    } // retranslateUi
